...
const getThemeAwareColor = (customColor?: string): string => {
...
const LightRays: React.FC<LightRaysProps> = ({
  ...
  const effectiveRaysColor = getThemeAwareColor(raysColor);
  ...
  useEffect(() => {
    ...
    const initializeWebGL = async () => {
      ...
      // Use additive blending so rays only lighten the background
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  fragColor = vec4(raysColor * intensity, intensity);
}
